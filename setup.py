...
setup(
    ...
    description="Lightweight CHIPS Wallet",
    author="Thomas Voegtlin, Komodo Platform",
    author_email="info@komodoplatform.com",
    license="MIT Licence",
    url="https://komodoplatform.com",
    long_description="""Lightweight CHIPS Wallet""",
)
